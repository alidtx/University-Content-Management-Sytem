...
// VC office Frontend
Route::get('/vc-office', 'Frontend\FrontController@VCoffice')->name('vcoffice');
Route::get('/vc-list', 'Frontend\FrontController@VCList')->name('VCList');
Route::get('/vc-office-stuff', 'Frontend\FrontController@vcstuff')->name('vcstuff');
Route::get('/vc-contact', 'Frontend\FrontController@vccontact')->name('vccontact');
...
Route::get('/syndicate-members','Backend\SyndicateMemberController@frontend')->name('syndicate_member');
...
Route::middleware(['auth'])->group(function(){
	...
	Route::group(['middleware'=>['permission']],function(){
		...
		Route::prefix('menu')->group(function(){
            ...
            Route::get('/view-home-link', 'Backend\Menu\MenuController@viewHomeLink')->name('home_link');
			Route::get('/add-home-link', 'Backend\Menu\MenuController@addHomeLink')->name('home_link.add');
			Route::post('/store-home-link', 'Backend\Menu\MenuController@storeHomeLink')->name('home_link.store');
			Route::get('/edit-home-link/{id}', 'Backend\Menu\MenuController@editHomeLink')->name('home_link.edit');
			Route::post('/update-home-link/{id}','Backend\Menu\MenuController@updateHomeLink')->name('home_link.update');
			Route::post('/delete-home-link','Backend\Menu\MenuController@deleteHomeLink')->name('home_link.delete');
		});
		...
		Route::prefix('setup')->group(function(){
			...
			Route::get('/faculty', 'Backend\Setup\ManageFacultyController@index')->name('setup.manage_faculty');
			Route::get('/faculty/add', 'Backend\Setup\ManageFacultyController@add')->name('setup.manage_faculty.add');
			Route::post('/faculty/store', 'Backend\Setup\ManageFacultyController@store')->name('setup.manage_faculty.store');
			Route::get('/faculty/edit/{id}', 'Backend\Setup\ManageFacultyController@edit')->name('setup.manage_faculty.edit');
			Route::post('/faculty/update/{id}', 'Backend\Setup\ManageFacultyController@update')->name('setup.manage_faculty.update');
			Route::get('/faculty/delete', 'Backend\Setup\ManageFacultyController@delete')->name('setup.manage_faculty.delete');

			Route::get('department','Backend\Setup\DepartmentController@index')->name('setup.department');
			Route::get('department/add','Backend\Setup\DepartmentController@addDepartment')->name('setup.department.add');
			Route::post('department/store','Backend\Setup\DepartmentController@storeDepartment')->name('setup.department.store');
			Route::get('department/edit/{id}','Backend\Setup\DepartmentController@editDepartment')->name('setup.department.edit');
			Route::post('department/update/{id}','Backend\Setup\DepartmentController@updateDepartment')->name('setup.department.update');
			Route::get('department/delete','Backend\Setup\DepartmentController@deleteDepartment')->name('setup.department.delete');

			Route::get('/program', 'Backend\Setup\ManageProgramController@index')->name('setup.manage_program');
			Route::get('/program/add', 'Backend\Setup\ManageProgramController@add')->name('setup.manage_program.add');
			Route::post('/program/store', 'Backend\Setup\ManageProgramController@store')->name('setup.manage_program.store');
			Route::get('/program/edit/{id}', 'Backend\Setup\ManageProgramController@edit')->name('setup.manage_program.edit');
			Route::post('/program/update/{id}', 'Backend\Setup\ManageProgramController@update')->name('setup.manage_program.update');
			Route::get('/program/delete', 'Backend\Setup\ManageProgramController@delete')->name('setup.manage_program.delete');


			Route::get('/office', 'Backend\Setup\OfficeController@index')->name('setup.manage_office');
			Route::get('/office/add', 'Backend\Setup\OfficeController@add')->name('setup.manage_office.add');
			Route::post('/office/store', 'Backend\Setup\OfficeController@store')->name('setup.manage_office.store');
			Route::get('/office/edit/{id}', 'Backend\Setup\OfficeController@edit')->name('setup.manage_office.edit');
			Route::post('/office/update/{id}', 'Backend\Setup\OfficeController@update')->name('setup.manage_office.update');
			Route::get('/office/delete', 'Backend\Setup\OfficeController@delete')->name('setup.manage_office.delete');

		});



		Route::get('/leave', 'Backend\LeaveController@index')->name('manage_leave');
		Route::get('/leave/add', 'Backend\LeaveController@add')->name('manage_leave.add');
		Route::post('/leave/store', 'Backend\LeaveController@store')->name('manage_leave.store');
		Route::get('/leave/edit/{id}', 'Backend\LeaveController@edit')->name('manage_leave.edit');
	    Route::post('/leave/update/{id}', 'Backend\LeaveController@update')->name('manage_leave.update');
		Route::get('/leave/delete', 'Backend\LeaveController@delete')->name('manage_leave.delete');



		Route::get('/hall', 'Backend\HallController@index')->name('manage_hall');
		Route::get('/hall/add', 'Backend\HallController@add')->name('manage_hall.add');
		Route::post('/hall/store', 'Backend\HallController@store')->name('manage_hall.store');
		Route::get('/hall/edit/{id}', 'Backend\HallController@edit')->name('manage_hall.edit');
		Route::post('/hall/update/{id}', 'Backend\HallController@update')->name('manage_hall.update');
		Route::get('/hall/delete', 'Backend\HallController@delete')->name('manage_hall.delete');


		Route::get('/view_hall_member/{id}','Backend\HallMemberController@viewHallMember')->name('view_hall_member')->where('id', '[0-9]+');
		Route::get('/hall_member/{id}', 'Backend\HallMemberController@add')->name('hall_member');
		Route::get('/member_wise_hall','Backend\HallMemberController@memberWiseHall')->name('member_wise_hall');
		Route::post('/hall_member/manage_hall_member/store', 'Backend\HallMemberController@hallmemberStore')->name('manage_hall_member.store');
        Route::get('/member_edit/{id}', 'Backend\HallMemberController@editMember')->name('member_edit');
		Route::post('/member_update/{id}', 'Backend\HallMemberController@memberUpdate')->name('member_update');
		Route::get('/member_delete','Backend\HallMemberController@memberDelete')->name('member_delete');




		Route::get('/hall_home', 'Backend\HallHomeController@index')->name('manage_hall_home');
		Route::get('/hall_home/add', 'Backend\HallHomeController@add')->name('manage_hall_home.add');
		Route::post('/hall_home/store', 'Backend\HallHomeController@store')->name('manage_hall_home.store');
		Route::get('/hall_home/edit/{id}', 'Backend\HallHomeController@edit')->name('manage_hall_home.edit');
		Route::post('/hall_home/update/{id}', 'Backend\HallHomeController@update')->name('manage_hall_home.update');
		Route::get('/hall_home/delete', 'Backend\HallHomeController@delete')->name('manage_hall_home.delete');



		Route::get('/department_home', 'Backend\DepartmentHomeController@index')->name('manage_department_home');
		Route::get('/department_home/add', 'Backend\DepartmentHomeController@add')->name('manage_department_home.add');
		Route::post('/department_home/store', 'Backend\DepartmentHomeController@store')->name('manage_department_home.store');
		Route::get('/department_home/edit/{id}', 'Backend\DepartmentHomeController@edit')->name('manage_department_home.edit');
		Route::post('/department_home/update/{id}', 'Backend\DepartmentHomeController@update')->name('manage_department_home.update');
		Route::get('/department_home/delete', 'Backend\DepartmentHomeController@delete')->name('manage_department_home.delete');



		Route::prefix('user')->group(function(){
			Route::get('/all-user', 'Backend\UserController@list')->name('user');
			Route::get('/all-users', 'Backend\UserController@list')->name('setup.manage_faculty');
			Route::get('/all-users', 'Backend\UserController@list')->name('setup.manage_department');
			// Route::get('/all-users', 'Backend\UserController@list')->name('setup.manage_faculty');
			Route::get('/all-users', 'Backend\UserController@list')->name('setup.manage_department');
		...
		Route::prefix('project-management')->group(function(){
			...
			//At a Galance
			Route::get('at_a_galance','Backend\Setup\AtGalanceController@index')->name('site-setting.at_a_galance');
			Route::get('at_a_galance/add','Backend\Setup\AtGalanceController@addAtGalance')->name('site-setting.at_a_galance.add');
			Route::post('at_a_galance/store','Backend\Setup\AtGalanceController@storeAtGalance')->name('site-setting.at_a_galance.store');
			Route::get('at_a_galance/edit/{id}','Backend\Setup\AtGalanceController@editAtGalance')->name('site-setting.at_a_galance.edit');
			Route::post('at_a_galance/update/{id}','Backend\Setup\AtGalanceController@updateAtGalance')->name('site-setting.at_a_galance.update');
			Route::get('at_a_galance/delete','Backend\Setup\AtGalanceController@deleteAtGalance')->name('site-setting.at_a_galance.delete');
			...
			//Director
			//Message
			Route::get('message','Backend\MessageController@index')->name('site-setting.message');
			Route::get('message/add','Backend\MessageController@add')->name('site-setting.message.add');
			Route::post('message/store','Backend\MessageController@store')->name('site-setting.message.store');
			Route::get('message/edit/{id}','Backend\MessageController@edit')->name('site-setting.message.edit');
			Route::post('message/update/{id}','Backend\MessageController@update')->name('site-setting.message.update');
			Route::get('message/delete','Backend\MessageController@destroy')->name('site-setting.message.delete');
			...
			Route::get('faculty-wise-department','Backend\NewsController@facultyWiseDepartment')->name('faculty_wise_department');
		...
		Route::prefix('annual-performance')->group(function(){
			// Annual Performance
			Route::get('/performance/view', 'Backend\PerformanceController@index')->name('annual-performance.performance.list');
			Route::get('/performance/add', 'Backend\PerformanceController@create')->name('annual-performance.performance.create');
			Route::post('/performance/store', 'Backend\PerformanceController@store')->name('annual-performance.performance.store');
			Route::get('/performance/edit/{id}','Backend\PerformanceController@edit')->name('annual-performance.performance.edit');
			Route::post('/performance/update/{id}','Backend\PerformanceController@update')->name('annual-performance.performance.update');
			Route::get('/performance/delete/{id}', 'Backend\PerformanceController@destroy')->name('annual-performance.performance.destroy');

			Route::get('/report/view', 'Backend\AnnualreportController@index')->name('annual-performance.report.list');
			Route::get('/report/add', 'Backend\AnnualreportController@create')->name('annual-performance.report.create');
			Route::post('/report/store', 'Backend\AnnualreportController@store')->name('annual-performance.report.store');
			Route::get('/report/edit/{id}','Backend\AnnualreportController@edit')->name('annual-performance.report.edit');
			Route::post('/report/update/{id}','Backend\AnnualreportController@update')->name('annual-performance.report.update');
			Route::get('/report/delete/{id}', 'Backend\AnnualreportController@destroy')->name('annual-performance.report.destroy');

		});

		// Annual Calendar Routine

		Route::prefix('academic-routine')->group(function(){
			Route::get('/routine-show', 'Backend\AcademiceventController@show')->name('academic-routine.event.show');
			Route::get('/routine-list', 'Backend\AcademiceventController@index')->name('academic-routine.event.list');
			Route::get('/routine/add', 'Backend\AcademiceventController@create')->name('academic-routine.event.create');
			Route::post('/routine/store', 'Backend\AcademiceventController@store')->name('academic-routine.event.store');
			Route::get('/routine/edit/{id}','Backend\AcademiceventController@edit')->name('academic-routine.event.edit');

			Route::post('/routine/update/{id}','Backend\AcademiceventController@update')->name('academic-routine.event.update');
			Route::get('/routine/delete/{id}', 'Backend\AcademiceventController@destroy')->name('academic-routine.event.destroy');
		});
		...
		Route::prefix('transports')->group(function(){
			...
			Route::get('/root_list', 'Backend\TransportController@index')->name('transport.list');
			Route::get('/root_create', 'Backend\TransportController@create')->name('transport.create');
			Route::post('/root_store', 'Backend\TransportController@store')->name('transport.store');
			Route::get('/root_edit/{id}', 'Backend\TransportController@edit')->name('transport.edit');
			Route::post('/root_update/{id}', 'Backend\TransportController@update')->name('transport.update');
			Route::get('/root_delete/{id}', 'Backend\TransportController@delete')->name('transport.delete');
		});
	...
	Route::prefix('frontend-menu')->group(function(){
		...
		Route::prefix('member-management')->group(function(){
			...
			Route::get('member-type-wise-designation','Backend\MemberController@MemberTypeWiseDesignation')->name('member_type_wise_designation');
		...
		Route::prefix('syndicate-members')->group(function(){
			Route::get('syndicate-members/list','Backend\SyndicateMemberController@list')->name('syndicate_member.list');
			Route::get('syndicate-members/add','Backend\SyndicateMemberController@add')->name('syndicate_member.add');
			Route::post('syndicate-members/store','Backend\SyndicateMemberController@store')->name('syndicate_member.store');
			Route::get('syndicate-members/edit/{id}','Backend\SyndicateMemberController@edit')->name('syndicate_member.edit');
			Route::post('syndicate-members/update/{id}','Backend\SyndicateMemberController@update')->name('syndicate_member.update');
			Route::get('syndicate-members/delete','Backend\SyndicateMemberController@destroy')->name('syndicate_member.delete');
		...
		Route::get('academic-councils/list','Backend\AcademicCouncilController@list')->name('academic-councils.list');
		Route::get('academic-councils/add','Backend\AcademicCouncilController@add')->name('academic-councils.add');
		Route::post('academic-councils/store','Backend\AcademicCouncilController@store')->name('academic-councils.store');
		Route::get('academic-councils/edit/{id}','Backend\AcademicCouncilController@edit')->name('academic-councils.edit');
		Route::post('academic-councils/update/{id}','Backend\AcademicCouncilController@update')->name('academic-councils.update');
		Route::get('academic-councils/delete','Backend\AcademicCouncilController@destroy')->name('academic-councils.delete');
		// End - Academic Coucil

		// Start - Department To Member
		Route::prefix('department-to-members')->group(function(){
			Route::get('list','Backend\DepartmentToFacultyMemberController@list')->name('department_to_members.list');
			Route::get('add','Backend\DepartmentToFacultyMemberController@add')->name('department_to_members.add');
			Route::post('store','Backend\DepartmentToFacultyMemberController@store')->name('department_to_members.store');
			Route::get('edit/{id}','Backend\DepartmentToFacultyMemberController@edit')->name('department_to_members.edit');
			Route::post('update/{id}','Backend\DepartmentToFacultyMemberController@update')->name('department_to_members.update');
			Route::get('delete','Backend\DepartmentToFacultyMemberController@destroy')->name('department_to_members.delete');
			Route::get('member-wise-designation','Backend\DepartmentToFacultyMemberController@MemberWiseDesignation')->name('member_wise_designation');
		...
		Route::prefix('office-to-members')->group(function(){
			...
			Route::get('list','Backend\OfficeToMemberController@list')->name('office_to_member.list');
			Route::get('add','Backend\OfficeToMemberController@add')->name('office_to_member.add');
			Route::post('store','Backend\OfficeToMemberController@store')->name('office_to_member.store');
			Route::get('edit/{id}','Backend\OfficeToMemberController@edit')->name('office_to_member.edit');
			Route::post('update/{id}','Backend\OfficeToMemberController@update')->name('office_to_member.update');
			Route::get('delete','Backend\OfficeToMemberController@destroy')->name('office_to_member.delete');
			Route::get('member-wise-designation','Backend\OfficeToMemberController@MemberWiseDesignation')->name('member_wise_designation');
		...
		Route::prefix('academic')->group(function(){
			Route::get('list','Backend\AcademicController@list')->name('academic.list');
			Route::get('add','Backend\AcademicController@add')->name('academic.add');
			Route::post('store','Backend\AcademicController@store')->name('academic.store');
			Route::get('edit/{id}','Backend\AcademicController@edit')->name('academic.edit');
			Route::post('update/{id}','Backend\AcademicController@update')->name('academic.update');
			Route::get('delete','Backend\AcademicController@destroy')->name('academic.delete');
			Route::get('department-wise-program','Backend\AcademicController@DepartmentWiseProgram')->name('department_wise_program');
		});
		// End - Academic
	...
	Route::prefix('footer-menu')->group(function(){
		...
		Route::get('category-wise-deptOrOffice','Backend\OfficeOrderController@categoryWiseDeptOrOffice')->name('category_wise_deptOrOffice');
		Route::get('department-wise-member','Backend\OfficeOrderController@departmentWiseMember')->name('department_wise_member');
		Route::get('office-wise-member','Backend\OfficeOrderController@officeWiseMember')->name('office_wise_member');
...
Route::get('/hall_provost_details/{id}', 'Frontend\FrontController@hallProvostDetails')->name('hall_provost_details');
//Dean Member profile Frontend End
