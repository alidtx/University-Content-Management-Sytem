...
class SiteSettingController extends Controller
{
    ...
    {
        $request->validate([
            'site_header_logo' => 'requred|mimes:jpg,jpeg,png',
            'site_footer_logo' => 'requred|mimes:jpg,jpeg,png',
            'site_favicon' => 'requred|mimes:jpg,jpeg,png',
            'site_banner_image' => 'requred|mimes:jpg,jpeg,png',
        ]);
        $params     = $request->all();
