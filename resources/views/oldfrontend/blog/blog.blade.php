                            ...
                            {{-- <div class="col-sm-12 col-md-3 col-lg-3"> --}}
                                <a href="{{ route('blog.details',$recentPost->id) }}" style="color: black !important;text-decoration: none !important;">
                                    <div class="facility">
                                        ...
                                        <img src="{{asset('public/upload/post_category/'.@$recentPost->image)}}" class="w-100" height="100px;" alt="COU Research" />
                    ...
                    <div class="col-12">
                        <div class="owl-carousel owl-theme">
                            ...
                            <a href="{{ route('blog.details',$topView->blog_post_id) }}" style="color: black !important;text-decoration: none !important;">
                                <div class="facility">
                                    <img src="{{asset('public/upload/post_category/'.@$topView->post->image)}}" class="w-100" height="100px;" alt="COU Research" />
                    ...
                    <div class="col-12">
                        <div class="owl-carousel owl-theme" style="white-space: 100%;">
                            ...
                            <a href="{{ route('blog.details',$postLike->id) }}" style="color: black !important;text-decoration: none !important;">
                                <div class="facility">
                                    <img src="{{asset('public/upload/post_category/'.@$postLike->image)}}" class="w-100" height="100px;" alt="COU Research" />
