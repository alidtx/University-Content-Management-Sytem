                                        ...
                                        <form method="post" action="{{ route('contact.message.store') }}" >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    <input name="name" required="required" placeholder="Full Name *"
                                                        id="first-name" class="form-control" name="name" type="text">
                                                </div><br><br><br>
                                                <div class="form-group col-12">
                                                    <input name="email" required="required" placeholder="Email *"
                                                        id="email" class="form-control" name="email" type="email">
                                                </div><br><br><br>
                                                <div class="form-group col-12">
                                                    <input name="phone" required="" placeholder="Phone" id="phone"
                                                        class="form-control" name="phone" type="tel">
                                                </div><br><br><br>
                                                <div class="form-group col-12">
                                                    <input name="subject" placeholder="Subject *" id="subject"
