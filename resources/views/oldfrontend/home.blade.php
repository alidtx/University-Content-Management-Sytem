    ...
    <section id="facilities">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="facility">
                        <img src="{{asset('public/upload/facility/'.@$list->image)}}" class="w-100" alt="COU Facilities" />
                        <h3>{{@$list->title}}</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <h3>Bangladesh Institute of Governance and Management</h3>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6">
    ...
    <section id="facilities" class="our_development">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="facility">
                        <img src="{{asset('public/upload/our_development/'.@$ourDevelopment->image)}}" class="w-100" height="176px;" alt="COU DEVELOPMENT" />
    ...
    <section id="facilities" class="our_library">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <div class="facility">
                        <img src="{{asset('public/upload/our_library/'.@$ourLibrary->image)}}" class="w-100" height="174px" alt="COU LIBRARY" />
