    ...
    <div class="row" style="">
      ...
      <div class="col-sm-12 col-md-5 col-lg-5">
        @if(@$controlTopLeftMenu->status == 1)
          <ul class="d-flex left">
            ...
            <li><a target="_blank" href="http://182.163.112.222/Bigm/UserAuthentication/Create" class="" style="color: yellow;">Apply Online</a></li>
          </ul>
        @endif
      </div>
      ...
      <div class="col-sm-12 col-md-7 col-lg-7">
        <ul class="d-flex right">
          <li style="padding-right: 0px;white-space: nowrap;"><a href="http://182.163.112.222/" target="_blank"><i class="fas fa-globe right-icons"></i> Old Web<span class="oldWebsiteShorter">site</span> </a></li>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 row">
      ...
      <div class="col-sm-12 col-md-2 col-lg-2">
        <div class="logo" style="text-align: center;">
          <a href="{{url('/')}}"><img src="{{asset('public/upload/institute_details/'.$instituteDetail->image)}}" alt="COU Logo" height="88px" style="padding-left: 10px;" /></a>
        </div>
      </div>
        ...
        <div id="header_slider" class="dark" style="border-radius: 0px;">
          <nav role="navigation">
            ...
            <ul class="main-nav" style="text-align: center;">
              ...
              <a href="{{url('/')}}" style="border-left: none !important;"><img onload="heightfind()" id="bigm_logo_for_sticky" style="display: none;background: white;vertical-align: center;margin-top: -.65vw;" src="{{asset('public/upload/institute_details/'.$instituteDetail->image)}}" alt="COU Logo" height="" width="100px" /></a>
