...
@section('content')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
      <div class="container">
        <div class="row">
          <div class="col">
            <h3 class="text-center" style="color: white;">Office</h3>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                <div class="row">
                  <div class="col-10 offset-0 offset-sm-2">
                      <h3 class="title-text my-font">Office Staffs</h3>
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="about-more" style="background: rgba(0, 178, 255, 0.05);padding-top: 25px;margin-bottom: 60px;">
    <div class="container">
        {{-- <h3 style="margin-bottom: 20px;">Office of the <span style="color: #00B2FF;">Vice Chancellor</span></h3> --}}
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-7">
                    ...
                    <p style="font-size: 20px;font-weight: 500;margin:20px 0;">Hossain Morshed Forhad</p>
