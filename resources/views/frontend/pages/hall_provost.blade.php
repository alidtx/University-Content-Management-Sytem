...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center" style="color: white;">Hall Provost</h3>
      </div>
    </div>
  </div>
</section>
          ...
          <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
            <div class="row">
              <div class="col-10 offset-0 offset-sm-2">
                <h3 class="title-text ">All Hall Provosts</h3>
              </div>
            </div>
          </div>
        </div>
...
@include('frontend.partial.content-blue-header', ['title' => 'All Hall Provosts'])
        ...
        <div class="card">
          <div class="card-body d-flex flex-column">
            ...
            <div class="heading-content">
              <h3 class="my-font" style="margin-bottom: 14px;">Provost Of {{@$item->name}}</span></h3>
            ...
            <a href="{{route('halls.hall_provost_details',@$item->id)}}" class="btn btn-primary btn-sm justify-self-end"
