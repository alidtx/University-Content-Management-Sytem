  ...
  <div class="container">
    <div class="hero-slider">
      ...
      <div class="hero-slider-item">
        <h2 class="text-white text-center">{{$officeHead->member->name}}{{$officeHead->member->member_designation}} </h2>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-md-4 mb-md-0">
        <div class="round-image">
          ...
          src="{{ asset('public/upload/members/'.$officeHead->member->image) }}"
          alt="about image"
          />
        </div>
      </div>
      <div class="col-md-8">
        ...
        <h2><span class="text-primary">{{$officeHead->member->member_designation}}</span></h2>
        <p>{!!$officeHead->member->about!!}</p>
