...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
	<div class="container">
		<div class="row">
			<div class="col">
				<h3 class="text-center font_one text-white" >{{ $officeHead->member->name }}</h3>
			</div>
		</div>
	</div>
</section>
					...
					<div class="advisor-img-container border mt-1 rounded overflow-hidden">
						<div class="p-4">
							<div class="round-image">
							    <img class="img-fluid w-100" src="{{ asset('public/upload/members/'.$officeHead->member->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/images/about/user-dummy.jpeg') }}';" alt="about image">
							</div>
						</div>
						<h4>{{ $officeHead->member->name }}</h4>
						<p>
							{{ $officeHead->member->member_designation }} <br>
                        ...
                        <div class="faculty-address-container">
                            <div class="row p-3 border-bottom">
                                ...
                                <div class="col-10">{{ $officeHead->member->phone }}</div>
                            </div>
                            <div class="row p-3 border-bottom">
                                <div class="col-2"><i class="ti-email"></i></div>
                                <div class="col-10">{{ $officeHead->member->email }}</div>
                            </div>
                            <div class="row p-3">
                                <div class="col-2"><i class="ti-location-pin"></i></div>
                                <div class="col-10">
                                    <p class="text-justify p-0">
                                        {{ $officeHead->member->work_place }}<br>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                  <div class="container">
                                    <div class="row">
                                      <div class="col-md-12">
                                        {{-- <div class="box"> --}}
                                            @if($officeHead->member->about != null)
                                          <p class="paragraph">{!!$officeHead->member->about!!}</p>
                                        {{-- </div> --}}
                                        @endif
                                      </div>
                                    </div>
