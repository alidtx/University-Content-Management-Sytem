            ...
            <div class="col-12">
                <div class="row my-5">
                    <div class="col-12 col-sm-6" style="background-color: #00B2FF;">
                        <h3 class="title-text my-font py-3 text-white ">Current Treasurer</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="row my-5">
                    <div class="col-12 col-sm-6" style="background-color: #00B2FF;">
                        <h3 class="title-text my-font py-3 text-white ">Former Treasurer</h3>
                    </div>
                </div>
            </div>
        </div>
