...
@include('frontend.layouts.treasurer_office_header')
	...
	<div class="container">
		<div class="row my-5">
			...
			<div class="col-12 col-sm-8">
				{{-- <h2>Message of the <span class="text-primary">Treasurer</span></h1>
					...
					<h2>Message of the <span class="text-primary">Vice Chancellor</span></h1>
						<p class="text-justify">
						...
						<div class="d-inline">
							...
							<b class="text-primary">Treasurer</b> <br />
