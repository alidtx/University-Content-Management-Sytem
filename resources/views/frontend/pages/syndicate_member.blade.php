...
@section('content')
    ...
    {{-- <section>
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="col-12 col-sm-6" style="background-color: #27a5db; margin: 40px 0;">
                <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <i style="color: #00B2FF;font-weight: 800;margin:15px 0;">{{$syndicate_member->committee_designation ? $syndicate_member->committee_designation : $syndicate_member->member->member_designation}}, {{$syndicate_member->member->work_place}}</i>
    ...
    <div class="row">
      <div class="container">
        <h3 class="my-font" style="margin-bottom: 20px;">Syndicate <span style="color: #00B2FF;">Member</span></h3>
      </div>
    </div>
    <section class="my-2">
      <div class="container">
    ...
    <div class="row">
      <div class="container">
        <h3 class="my-font" style="margin-bottom: 20px;">Syndicate <span style="color: #00B2FF;">Secretary</span></h3>
      </div>
    </div>
    <section class="">
      <div class="container">
