		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-sm-8">
                    ...
                    <div class="blog-post">
                    <h3 class="blog_headline">{{$post->title}}</h3>
                     <span>Date: {{date_format($post->created_at,"Y/m/d")}} || </span> <span>Writen by: {{$post->author_name}}</span>
                     <br>
                     <div class="blog_img"> <img src="{{asset('public/upload/blogs/'.$post->image)}}" alt=""> </div>
