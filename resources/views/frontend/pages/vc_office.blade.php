    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-12 col-sm-4">
                <div class="mb-md-0">
                    <div class="round-image">
                        {{-- <img class="img-fluid w-100" src="{{ asset('public/frontend/images/about/vc.png') }}"
                            alt="about image" /> --}}
            ...
            <div class="col-12 col-sm-8">
                ...
                <h2>Message of the <span class="text-primary">Vice Chancellor</span></h2>
                ...
                <div class="d-inline">
                    ...
                    <h6>31 January 2022 to present</h6>
                ...
                <div class="card contact-card my-4">
                    <div class="card-body">
                        <div class="inner-items-contactas">
                            <div class="row">
                                <div class="col-4 p-0"><img class="img-fluid d-block"
                                        src="{{ asset('public/frontend/images/icons/location.png') }}" alt="">
                                </div>
                                <div class="col-8" style="margin-top: 35px; margin-left: -25px;">
