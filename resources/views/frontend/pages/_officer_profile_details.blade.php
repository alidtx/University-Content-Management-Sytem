  ...
  <div class="container">
    <div class="hero-slider">
      ...
      <div class="hero-slider-item">
        <h2 class="text-white text-center">{{$officerProfile->name}}{{$officerProfile->member_designation}} </h2>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-md-4 mb-md-0">
        <div class="round-image">
          ...
          src="{{ asset('public/upload/members/'.$officerProfile->image) }}"
          alt="about image"
          />
        </div>
      </div>
      <div class="col-md-8">
        ...
        <h2><span class="text-primary">{{$officerProfile->member_designation}}</span></h2>
        <p>{!!@$officerProfile->member->about!!}</p>
