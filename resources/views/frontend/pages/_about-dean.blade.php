...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner.png') }}); background-position: center center; background-size:cover;">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center font_four text-white">{{$deanDetails->member->name}}</h3>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-md-4 mb-md-0">
        <div class="round-image">
          ...
          src="{{ asset('public/upload/members/'. $deanDetails->member->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/cuimages/user-dummy.jpeg') }}';"
          alt="about image"
          />
        </div>
      </div>
      <div class="col-md-8">
        ...
        <h4><span class="text-primary">{{$deanDetails->member->member_designation}}</span></h4>
