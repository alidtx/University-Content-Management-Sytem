        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInRightBig">Welcome to <span style="color: #00b2ff">Law Faculty</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_2.jpg') }}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInUpBig">Welcome to <span style="color: #00b2ff">Law Faculty</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_3.jpg') }}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="animated fadeInDownBig">Welcome to <span style="color: #00b2ff">Law Faculty</span></h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4 mb-md-0">
            <div class="round-image">
              <img
                ...
                src="{{ asset('public/frontend/images/about/shamimul_islam.png') }}"
                alt="about image"
              />
            </div>
          </div>
          <div class="col-md-8">
            <h2>Message from the <span class="text-primary">Dean</span> Faculty Of  Law </h2>
            <p>
            ...
            <div class="d-inline">
            <h4>Professor Dr. Md. Shamimul Islam</h4>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              ...
              <div class="content">
                <h4 class="mb-0 text-white">Law</h4>
