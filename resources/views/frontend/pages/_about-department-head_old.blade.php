  ...
  <div class="container">
    <div class="hero-slider">
      ...
      <div class="hero-slider-item">
        <h2 class="text-white text-center">{{$departmentDetails->member->name}}{{$departmentDetails->member->member_designation}} </h2>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-md-4 mb-md-0">
        <div class="round-image">
          ...
          src="{{ asset('public/upload/members/'.$departmentDetails->member->image) }}"
          alt="about image"
          />
        </div>
      </div>
      <div class="col-md-8">
        ...
        <h2><span class="text-primary">{{$departmentDetails->member->member_designation}}</span></h2>
        <p>{!!$departmentDetails->member->about!!}</p>
