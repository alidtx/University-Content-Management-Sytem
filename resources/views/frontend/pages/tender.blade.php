...
@section('content')
    ...
    <section class="counter-numbers"
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="text-center my-font" style="color: white;">Tender</h3>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                    <div class="row">
                        <div class="col-10 offset-0 offset-sm-2">
                            <h3 class="title-text my-font" style="margin-left:-102px">Tenders</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="card-body">
                            ...
                            @foreach ($tenders as $tender)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                            ...
                                            <a href="{{ asset('public/upload/office_order/' . $tender->attachment) }}"
                                                ...
                                                <div class="modal-dialog" role="document" style="max-width: 80% !important">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <iframe
                                                                src="{{ asset('public/upload/office_order/' . $tender->attachment) }}"
                                                                width="100%" height="600">
                                                                This browser does not support PDFs. Please download the
                                                                PDF to view it:
                                                                <a
                                                                    href="{{ asset('public/upload/office_order/' . $tender->attachment) }}">Download
                                                                    PDF</a>
                                                            </iframe>
                                                        </div>
                    ...
                    {{-- <p class="pagination">{{$tenders->links()}}</p> --}}
                </div>
