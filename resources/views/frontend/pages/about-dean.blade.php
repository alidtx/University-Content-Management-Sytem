...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
	<div class="container">
		<div class="row">
			<div class="col">
				<h3 class="text-center font_one text-white" >{{ $deanDetails->member->name }}</h3>
			</div>
		</div>
	</div>
</section>
					...
					<div class="advisor-img-container border mt-1 rounded overflow-hidden">
						<div class="p-4">
							<div class="round-image">
							    <img class="img-fluid w-100" src="{{ asset('public/upload/members/'.$deanDetails->member->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/images/about/user-dummy.jpeg') }}';" alt="about image">
							</div>
						</div>
						<h4>{{ $deanDetails->member->name }}</h4>
						<p>
							{{ $deanDetails->member->member_designation }} <br>
                        ...
                        <div class="faculty-address-container">
                            <div class="row p-3 border-bottom">
                                ...
                                <div class="col-10">{{ $deanDetails->member->phone }}</div>
                            </div>
                            <div class="row p-3 border-bottom">
                                <div class="col-2"><i class="ti-email"></i></div>
                                <div class="col-10">{{ $deanDetails->member->email }}</div>
                            </div>
                            <div class="row p-3">
                                <div class="col-2"><i class="ti-location-pin"></i></div>
                                <div class="col-10">
                                    <p class="text-justify p-0">
                                        {{ $deanDetails->member->work_place }}<br>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                  <div class="container">
                                    <div class="row">
                                      <div class="col-md-12">
                                        {{-- <div class="box"> --}}
                                            @if($deanDetails->member->about != null)
                                          <p class="paragraph">{!!$deanDetails->member->about!!}</p>
                                        {{-- </div> --}}
                                        @endif
                                      </div>
                                    </div>
