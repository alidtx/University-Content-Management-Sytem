...
@section('content')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png') }})">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="text-center" style="color: white;">Dean Profile</h3>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                            <div class="row">
                                <div class="col-10 offset-0 offset-sm-2">
                                    <h3 class="title-text">All Deans</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="heading-content ">
                                    ...
                                    <h3 class="pro_name">{{ @$item->member->name }}</h3>
                                ...
                                <a href="{{ route('faculties.dean_profile_details', @$item->id) }}"
