...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
	<div class="container">
		<div class="row">
			<div class="col">
				<h3 class="text-center font_one text-white" >{{ $vcAbout->name }}</h3>
			</div>
		</div>
	</div>
</section>
					...
					<div class="advisor-img-container border mt-1 rounded overflow-hidden">
						<div class="p-4">
							<div class="round-image">
							    <img class="img-fluid w-100" src="{{ asset('public/upload/members/'.$vcAbout->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/images/about/user-dummy.jpeg') }}';" alt="about image">
							</div>
						</div>
						<h4>{{ $vcAbout->name }}</h4>
						<p>
							{{ $vcAbout->member_designation }} <br>
					  	...
					  	<div class="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="experience-tab">
					  		<div class="container">
                                <div class="row">
                                    ...
                                    <table class="table table-striped">
                                        @foreach ($vcAdministrativeExperiences as $memberExperience)
