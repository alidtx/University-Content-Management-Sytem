...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }}); margin-top: 95px;">
	<div class="container">
		<div class="row">
			<div class="col">
					...
					<div class="advisor-img-container border mt-1 rounded overflow-hidden">
						<div class="p-4">
							<div class="round-image">
							    <img class="img-fluid w-100" src="{{ asset('public/upload/members/'.$facultyMember->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/images/about/user-dummy.jpeg') }}';" alt="about image">
							</div>
						</div>
