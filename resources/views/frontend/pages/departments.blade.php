...
{{-- <section class="counter-numbers"
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center font_four" style="color: white;">All Departments</h3>
      </div>
    </div>
  </div>
</section>
          ...
          <div class="overlay">
            <div class="text">
              <a href="{{ route('departments.department-details', $item->short_url) }}" class="btn btn-primary"
                style="font-family: Work Sans;font-size: 14px;">{{ $item->name }}</a>
            </div>
          </div>
        </div>
      </div>
