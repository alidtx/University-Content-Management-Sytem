...
@section('content')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png') }})">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="text-center my-font" style="color: white;">All Press Releases</h3>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                    <div class="row">
                        <div class="col-10 offset-0 offset-sm-2">
                            <h3 class="title-text my-font" style="margin-left:-102px">Press Releases</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex flex-column">
                                <ul class="list-unstyled mt-3 mt-sm-0">
                                    <li class=" mb-3">
                                        <a href="{{ route('press_releases_details', $event->id) }}">
                                            <div class="row">
                                                <div class="col-1">
                                                    @if($event->image)
