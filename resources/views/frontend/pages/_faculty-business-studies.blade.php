        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInRightBig">Welcome to <span style="color: #00b2ff">Faculty Of  Business Studies</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_2.jpg') }}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInUpBig">Welcome to <span style="color: #00b2ff">Faculty Of  Business Studies</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_3.jpg') }}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="animated fadeInDownBig">Welcome to <span style="color: #00b2ff">Faculty Of  Business Studies</span></h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4 mb-md-0">
            <div class="round-image">
              <img
                ...
                src="{{ asset('public/frontend/images/about/amzad.jpg') }}"
                alt="about image"
              />
            </div>
          </div>
          <div class="col-md-8">
            <h2>Message from the <span class="text-primary">Dean</span>Faculty Of  Business Studies</h2>
            <p>
            ...
            <div class="d-inline">
            <h4>Professor Dr. Mohammad Amzad Hossain Sarker</h4>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              ...
              <div class="content">
                <h4 class="mb-0 text-white">Management Studies</h4>
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Accounting and Information Systems</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Finance and Banking</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
