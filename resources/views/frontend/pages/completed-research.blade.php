...
@include('frontend.partial.content-blue-header', ['title' => 'Research'])
                    ...
                    <table id="dataTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->journal_index }}</td>
                                <td>{{ $item->journal_category }}</td>
                                <td>{{ $item->url }}</td>
                                <td>
                                    <img src="{{asset('public/upload/journal/'.$item['image']) }}" width="80"
                                        height="80"
                                        onerror="this.onerror=null;this.src='{{ asset('public/frontend/cuimages/dummy.png') }}';">
                                </td>
                                <td>
                                    <a class="btn btn-sm btn-primary"
                                        href="{{ asset('public/upload/journal/' . @$item->file) }}"
                                        download="">Download</a>
