...
@section('title', 'Faculty of Arts and Humanities')
@section('content')
        ...
        <div class="container">
          <nav class="navbar navbar-expand-lg navbar-dark p-0">
            <a class="navbar-brand" href="{{ route('home') }}" style="font-weight:600;text-transform: uppercase; "
              >FACULTY OF Arts and Humanities</a>
            <button
          ...
          <div class="col-md-4 mb-md-0">
            <div class="round-image">
              <img
                ...
                src="{{ asset('public/frontend/images/about/mowla.png') }}"
                alt="about image"
              />
            </div>
          </div>
          <div class="col-md-8">
            <h2>Message from the <span class="text-primary">Dean</span> Faculty Of Arts and Humanities </h2>
            <p>
...
Comilla University (Bengali: কুমিল্লা বিশ্ববিদ্যালয়) is a public university located at Kotbari, Comilla, Bangladesh. The university was constructed on 50 acres (200,000 m2) of land at Lalmai Bihar, Moynamoti. Comilla University is affiliated by University Grants Commission, Bangladesh.
            ...
            <div class="d-inline">
            <h4>Professor Dr. Mohammad Golam Mowla</h4>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              ...
              <div class="content">
                <h4 class="mb-0 text-white">English</h4>
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Bangla</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
