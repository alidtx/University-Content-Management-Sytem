  ...
  <div class="container">
    <div class="hero-slider">
      ...
      <div class="hero-slider-item">
        <h2 class="text-white text-center">{{$deanDetails->member->name}} {{$deanDetails->member->member_designation}} </h2>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-md-4 mb-md-0">
        <div class="round-image">
          ...
          src="{{ asset('public/upload/members/'.$deanDetails->member->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/images/about/user-dummy.jpeg') }}';"
          alt="about image"
          />
        </div>
      </div>
      <div class="col-md-8">
        <h2>{{$deanDetails->member->name}}</h2>
        <h2><span class="text-primary">{{$deanDetails->member->member_designation}}</span></h2>
        <p>{!!$deanDetails->member->about!!}</p>
