...
@section('title', 'Faculty of Social Science')
          ...
          <div class="hero-slider-item">
            <div class="row">
              <div class="col-md-8 text-center">
                ...
                >
                  Welcome to 
                <span style="color: #00b2ff">Social Science Faculty</span>
                </h1>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInRightBig">Welcome to <span style="color: #00b2ff">Social Science Faculty</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_2.jpg') }}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
                <h1 class="animated fadeInUpBig">Welcome to <span style="color: #00b2ff">Social Science Faculty</span></h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('public/frontend/images/banner/save_3.jpg') }}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 class="animated fadeInDownBig">Welcome to <span style="color: #00b2ff">Social Science Faculty</span></h1>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4 mb-md-0">
            <div class="round-image">
              <img
                ...
                src="{{ asset('public/frontend/images/about/Visa_photo_Robi_sir.jpg') }}"
                alt="about image"
              />
            </div>
          </div>
          <div class="col-md-8">
            <h2>Message from the <span class="text-primary">Dean</span> Faculty Of Social Science </h2>
            <p>
            ...
            <div class="d-inline">
            <h4>N. M. Rabiul Awal Chowdhury</h4>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              ...
              <div class="content">
                <h4 class="mb-0 text-white">Archaeology</h4>
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Economics</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Public Administration</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Anthropology</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 mb-4">
            <div class="inside d-flex">
              <img  class="mr-2" src="{{ asset('public/frontend/images/faculty/science/icon1.png') }}" alt="">
              <div class="content">
                <h4 class="mb-0 text-white">Mass Communication and Journalism</h4>
                <p class="mb-0">78 Courses</p>
              </div>
            </div>
          </div>
