...
@section('content')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png') }})">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="text-center my-font" style="color: white;">About of {{ @$office->name }}</h3>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                    <div class="row">
                        <div class="col-10 offset-0 offset-sm-2">
                            <h3 class="title-text my-font">About</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="heading-content ">
                                    ...
                                    <h3 class="my-font"> {{ @$item->office->name }} </span></h3>
                                    <p class="pro_name">{!! @$item->description !!}</p>
                            ...
                            <p class="desgination">{{@$item->member->member_designation}}, </p>
                            <small style="">Cell Phone: {{@$item->member->phone}}</small><br>
                            <small style="">Email: {{@$item->member->email}}</small><br><br>
                            <div class="button">
                            </div> --}}
