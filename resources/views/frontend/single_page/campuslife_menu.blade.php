  ...
  <div class="navigation w-100">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark p-0" style="line-height: 0px;">
        ...
        >Department Of  {{ $department->name }}</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@about">
              <a class="nav-link" href="{{ route('academy-menu',$department->id) }}">Academics</a>
            </li>
            <li class="nav-item @@courses">
              <a class="nav-link" href="{{ route('admission-menu',$department->id) }}">Admission</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('offices-menu',$department->id) }}">Offices</a>
            </li>
            <li class="nav-item @@blog">
              <a class="nav-link" href="{{ route('research-menu',$department->id) }}">Research</a>
            </li>
            <li class="nav-item active" style="white-space: nowrap;">
              <a class="nav-link" href="{{ route('campuslife-menu',$department->id) }}">Campus Life</a>
            </li>
          </ul>
        </div>
      </nav>
