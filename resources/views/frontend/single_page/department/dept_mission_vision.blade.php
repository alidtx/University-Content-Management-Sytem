...
@php
$pageTitle='Mission & Vision - Department of '. @$department->name
@endphp
...
{{-- <section class="counter-numbers"
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Mission & Vision of Department of {{ @$department->name }}
        </h3>
      </div>
    </div>
  </div>
          ...
          <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
            <div class="row">
              <div class="col-10 offset-0 offset-sm-2">
                <h3 class="title-text my-font">Mission & Vision</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-12 col-sm-12">
        <div class="card">
          <div class="card-body" style="padding-bottom: 10px;">
            <p class="card-text" style="font-weight: 700;font-size: 20px;">{!! @$departmentMissionVision->about !!}</p>
          </div>
        </div>
      </div>
    </div>
