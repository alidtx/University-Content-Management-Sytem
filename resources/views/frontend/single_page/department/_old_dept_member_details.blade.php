              ...
              <div class="row p-3">
                ...
                <div class="col-10">
                  <p class="text-justify p-0">
                    ...
                    Department of {{ $department->department->name }}<br>
                  ...
                  <div class="col-sm-12 ">
                    <nav>
                      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active col-12 col-sm-5 my-1 text-left"
                          id="nav-professional_experience-tab" data-toggle="tab" href="#nav-professional_experience"
                          role="tab" aria-controls="nav-professional_experience" aria-selected="true">Professional
                          Experience</a>
                        <a class="nav-item nav-link col-12 col-sm-5 my-1 text-left"
                          id="nav-administrative_experience-tab" data-toggle="tab" href="#nav-administrative_experience"
                          role="tab" aria-controls="nav-administrative_experience" aria-selected="false">Administrative
                          Experience</a>
                      </div>
                    </nav>
                  ...
                  <div class="col-sm-12 ">
                    <nav>
                      <div class="nav nav-tabs nav-fill row" id="nav-tab-publication" role="tablist">
                        <a class="nav-item nav-link active col-12 col-sm-5 my-1 text-left" id="nav-publish_journal-tab"
                          data-toggle="tab" href="#nav-publish_journal" role="tab" aria-controls="nav-publish_journal"
                          aria-selected="false">Publish Journal</a>
                        <a class="nav-item nav-link col-12 col-sm-5 my-1 text-left" id="nav-publish_book-tab"
                          data-toggle="tab" href="#nav-publish_book" role="tab" aria-controls="nav-publish_book"
                          aria-selected="true">Publish Book</a>
                        <a class="nav-item nav-link col-12 col-sm-5 my-1 text-left" id="nav-conference-tab"
                          data-toggle="tab" href="#nav-conference" role="tab" aria-controls="nav-conference"
