...
@php
$pageTitle='Message from Chairman - Department of '. @$department->name
@endphp
...
{{-- <section class="counter-numbers"
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Message from Chairman of Department of {{
          @$department->name }}</h3>
      </div>
    </div>
  </div>
          ...
          <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
            <div class="row">
              <div class="col-10 offset-0 offset-sm-2">
                <h3 class="title-text my-font">Message</h3>
              </div>
            </div>
          </div>
        </div>
...
@include('frontend.partial.content-blue-header', ['title' => 'Message'])
  ...
  <div class="container">
    <div class="row my-5">
      <div class="col-12 col-sm-4">
        <div class="round-image">
          <img class="img-fluid w-100"
            src="{{ asset('storage/app/public/media/departments/'.$message->member->image) }}"
      ...
      <div class="col-12 col-sm-8">
        ...
        <h4><a href="{{ route('departments.department_member_details', @$message->member_id) }}"
            class=" ustify-self-end" style="color: rgb(21, 13, 176); margin-top: auto;"> {{ $message->member->name
            }}</a></h4>
        <p>{{ $message->member->member_designation }}</p>
        <div class="my-2">
          {!! $message->long_description !!}</div>
