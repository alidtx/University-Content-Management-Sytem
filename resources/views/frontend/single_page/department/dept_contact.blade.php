...
@php
$pageTitle='Contact - Department of '. @$department->name
@endphp
...
{{-- <section class="counter-numbers"
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Contact of Department of {{ @$department->name }}</h3>
      </div>
    </div>
  </div>
</section>
          ...
          <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
            <div class="row">
              <div class="col-10 offset-0 offset-sm-2">
                <h3 class="title-text my-font">Contact</h3>
              </div>
            </div>
          </div>
        </div>
...
@include('frontend.partial.content-blue-header', ['title' => 'Contact'])
      ...
      <div class="col-12 col-sm-5">
        <div class="query-form shadow">
          ...
          <div class="phone mb-4">
            ...
            <p>
              Phone: {{$department->contact_number}} <br>
              Fax: (+88) 02334411135
            </p>
          </div>
