    ...
    <div class="carousel-inner">
      {{-- <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h2 class="animated fadeInRightBig">Welcome to Faculty of <span style="color: #00b2ff"> {{ $faculty->name }}</span></h2>
        </div>
      </div>
   ...
   @foreach($department as $list)
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <div class="inside d-flex">
          ...
          <div class="content">
           <a href="{{url('department-details/'. encrypt($list->id))}}">
            ...
            <div class="col-12 col-sm-6">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                      ...
                      <p class="news-date">Craig Bator - 27 Dec 2020</p>
                  ...
                  <div class="carousel-item">
                      <img class="d-block img-fluid" src="{{ asset('public/frontend/images/events/event-2.jpg') }}" alt="Second slide">
                      <p class="news-date">Craig Bator - 27 Dec 2020</p>
                      <h4 class="news-title">Now Is the Time to Think About Your Small  Business Success</h4>
                      <p class="news-subtitle">Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Minus, exercitationem! Voluptatem minus eaque ab tempora, provident? Vitae sapiente saepe atque asperiores nihil, eaque. Quaerat temporibus corrupti molestias, reprehenderit saepe dolor!</p>
                  </div>
                  <div class="carousel-item">
                      <img class="d-block img-fluid" src="{{ asset('public/frontend/images/events/event-3.jpg') }}" alt="Third slide">
                      <p class="news-date">Craig Bator - 27 Dec 2020</p>
                      <h4 class="news-title">Now Is the Time to Think About Your Small  Business Success</h4>
                      <p class="news-subtitle">Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Minus, exercitationem! Voluptatem minus eaque ab tempora, provident? Vitae sapiente saepe atque asperiores nihil, eaque. Quaerat temporibus corrupti molestias, reprehenderit saepe dolor!</p>
                  </div>
                  <div class="carousel-item">
                      <img class="d-block img-fluid" src="{{ asset('public/frontend/images/events/event-4.jpg') }}" alt="Fourth slide">
                      <p class="news-date">Craig Bator - 27 Dec 2020</p>
                      <h4 class="news-title">Now Is the Time to Think About Your Small  Business Success</h4>
                      <p class="news-subtitle">Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Minus, exercitationem! Voluptatem minus eaque ab tempora, provident? Vitae sapiente saepe atque asperiores nihil, eaque. Quaerat temporibus corrupti molestias, reprehenderit saepe dolor!</p>
                  </div>
                  <div class="carousel-item">
                      <img class="d-block image-fluiid"  src="{{ asset('public/frontend/images/events/event-5.jpg') }}" alt="Fifth slide">
                      <p class="news-date">Craig Bator - 27 Dec 2020</p>
                      <h4 class="news-title">Now Is the Time to Think About Your Small  Business Success</h4>
                      <p class="news-subtitle">Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Minus, exercitationem! Voluptatem minus eaque ab tempora, provident? Vitae sapiente saepe atque asperiores nihil, eaque. Quaerat temporibus corrupti molestias, reprehenderit saepe dolor!</p>
                  </div>
            ...
            <div class="col-12 col-sm-6">
              <ol class="carousel-indicators">
                  ...
                  <div data-target="#carouselExampleIndicators" data-slide-to="1">
                    <div class="row">
                      <div class="col-4 p-0">
                        <img class="img-fluid" src="{{ asset('public/frontend/images/events/event-2.jpg') }}" alt="thumbnail">
                      </div>
                      <div class="col-8">
                        <p class="news-date">Craig Bator - 27 Dec 2020</p>
                        <h4 class="news-title-2">Now Is the Time to Think About Your Small  Business Success</h4>
                  ...
                  <div data-target="#carouselExampleIndicators" data-slide-to="2">
                    <div class="row">
                      <div class="col-4 p-0">
                        <img class="img-fluid" src="{{ asset('public/frontend/images/events/event-3.jpg') }}" alt="thumbnail">
                      </div>
                      <div class="col-8">
                        <p class="news-date">Craig Bator - 27 Dec 2020</p>
                        <h4 class="news-title-2">Now Is the Time to Think About Your Small  Business Success</h4>
                  ...
                  <div data-target="#carouselExampleIndicators" data-slide-to="3">
                    <div class="row">
                      <div class="col-4 p-0">
                        <img class="img-fluid" src="{{ asset('public/frontend/images/events/event-4.jpg') }}" alt="thumbnail">
                      </div>
                      <div class="col-8">
                        <p class="news-date">Craig Bator - 27 Dec 2020</p>
                        <h4 class="news-title-2">Now Is the Time to Think About Your Small  Business Success</h4>
                  ...
                  <div data-target="#carouselExampleIndicators" data-slide-to="4">
                    <div class="row">
                      <div class="col-4 p-0">
                        <img class="img-fluid" src="{{ asset('public/frontend/images/events/event-5.jpg') }}" alt="thumbnail">
                      </div>
                      <div class="col-8">
                        <p class="news-date">Craig Bator - 27 Dec 2020</p>
                        <h4 class="news-title-2">Now Is the Time to Think About Your Small  Business Success</h4>
        ...
        <div class="col-md-4">
          <div class="card contact-card">
            <div class="card-body">
              ...
              <p class="my-font">{{ $faculty->contact_number }}</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
