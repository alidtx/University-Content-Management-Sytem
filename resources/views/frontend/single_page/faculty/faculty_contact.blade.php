...
@php
$pageTitle='Contact - Faculty of '. @$faculty->name
@endphp
...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Contact of Faculty of {{ @$faculty->name }}</h3>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-12 col-sm-5">
        <div class="query-form shadow">
          ...
          <div class="phone mb-4">
            ...
            <p>
              Phone: {{$faculty->contact_number}} <br>
              Fax: (+88) 02334411135
            </p>
          </div>
