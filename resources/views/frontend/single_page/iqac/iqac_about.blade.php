...
@include('frontend.layouts.iqac_office_header')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
      <div class="container">
        <div class="row">
          <div class="col">
            <h3 class="text-center my-font" style="color: white;">About IQAC</h3>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                <div class="row">
                  <div class="col-10 offset-0 offset-sm-2">
                      <h3 class="title-text my-font" style="margin-left:-102px">About</h3>
                  </div>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container">
              ...
              <div class="row">
         @foreach ($iqacAbout as $item )
                <div class="col-6 col-sm-6">
                    {{-- <h3>WELCOME TO INSTITUTIONAL QUALITY ASSURANCE CELL (IQAC) </h3> --}}
                     <h5>IQAC About</h5>
                     <p>{!!$item->description!!}</p>
                </div>

                <div class="col-6 col-sm-6 round-img">
                 <img src="{{asset('public/storage/media/igabout/'.$item->image)}}" alt="">
                </div>
                </div>
                @endforeach
