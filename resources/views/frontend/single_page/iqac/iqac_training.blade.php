...
@php
$pageTitle='Training Workshop/Seminar - IQAC Cell';
@endphp
...
@include('frontend.layouts.iqac_office_header')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
      <div class="container">
        <div class="row">
          <div class="col">
            <h3 class="text-center my-font" style="color: white;">IQAC Training Workshop/Seminar</h3>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                <div class="row">
                  <div class="col-10 offset-0 offset-sm-2">
                      <h3 class="title-text my-font" style="margin-left:-102px">Training Workshop/Seminar</h3>
                  </div>
                </div>
          </div>
        </div>
            ...
            <div class="col-12 col-sm-12">
                ...
                <div class="card-body" style="padding-bottom: 10px;">
                        ...
                        <table id="dataTable" class="table table-sm table-bordered table-striped">
                          <thead>
                            <tr>
                              <th width="5%">#</th>
                              <th width="15%">Training/workshop/seminar</th>
                              <th width="15%">Schedule</th>
                              <th width="15%">Participant</th>
                              <th width="20%">Facilator(s)/Research(s)/Person(s)</th>
              ...
              @foreach ($training as $item)
                            <tr>
                              ...
                              <td> {{$item->traning}}/{{$item->work_shop}}/{{$item->seminar}} </td>
