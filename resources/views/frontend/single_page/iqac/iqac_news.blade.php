...
@php
$pageTitle='News & Events - IQAC Cell';
@endphp
...
@include('frontend.layouts.iqac_office_header')
    ...
    <section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
      <div class="container">
        <div class="row">
          <div class="col">
            <h3 class="text-center my-font" style="color: white;">IQAC News & Events</h3>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
                <div class="row">
                  <div class="col-10 offset-0 offset-sm-2">
                      <h3 class="title-text my-font" style="margin-left:-102px">News & Events</h3>
                  </div>
                </div>
          </div>
        </div>
                    ...
                    <ul class="list-unstyled mt-3 mt-sm-0">
                        <li class=" mb-3">
                            <a href="#">
                                <div class="row">
                                    <div class="col-1">
                                        <img src="{{ asset('public/upload/news/'.$item->image) }}" onerror="this.onerror=null;this.src='{{ asset('public/frontend/cuimages/dummy.png') }}';" alt="" class="img-fluid">
                                    </div>
                                    <div class="col-11">
                                        <h4>{{$item->title}}</h4>
                                        <p><small>{{$item->start_date}}</small></p>
                                    </div>
                                </div>
                            </a>
                        </li>
