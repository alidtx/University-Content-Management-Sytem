...
@php
$pageTitle='All Provosts - '. @$halls->name;
@endphp
...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Hall Provost</h3>
      </div>
    </div>
  </div>
</section>

@include('frontend.partial.content-blue-header', ['title' => 'Hall Provost'])
      ...
      <div class="col-md-3 fix-height">
        <div class="card">
          <div class="card-body d-flex flex-column">
            ...
            <a href="{{route('halls.provost_details',@$item->member->id)}}"
