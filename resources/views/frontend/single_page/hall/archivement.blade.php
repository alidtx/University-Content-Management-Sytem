...
@php
$pageTitle='Archivement - '. @$halls->name
@endphp
...
<section class="counter-numbers" style="background: url({{ asset('public/frontend/images/banner/faculty.png')  }})">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="text-center my-font" style="color: white;">Archivement</h3>
      </div>
    </div>
  </div>
</section>
          ...
          <div class="col-12 col-sm-6" style="background-color: #00B2FF; margin: 40px 0;">
            <div class="row">
              <div class="col-10 offset-0 offset-sm-2">
                <h3 class="title-text my-font">Archivement</h3>
              </div>
            </div>
          </div>
        </div>
...
@include('frontend.partial.content-blue-header', ['title' => 'Archivement'])
