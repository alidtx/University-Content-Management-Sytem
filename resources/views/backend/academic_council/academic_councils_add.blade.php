...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Academic Council' : '' }} </h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Academic Councils</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('academic-councils.list')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Academic Councils</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('academic-councils.update',$editData->id) : route('academic-councils.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="form-row">
                        ...
                        <button class="btn bg-gradient-success btn-flat"><i class="fas fa-save"></i> {{ !empty($editData)? 'Update Syndicate Member' : 'Save Syndicate Member' }}</button>
                </form>
