        	...
        	<div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12 col-xl-12">
                    ...
                    <a href="{{ route('library-management.books_publications.filter_publications_journals') }}" class="btn btn-sm btn-info float-right" style="margin-right: 2px;"><i class="fas fa-stream"></i> COU Publications / Journals</a>
