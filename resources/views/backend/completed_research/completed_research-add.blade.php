@extends('backend.layouts.app') @section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ !empty($editData) ? 'Update Completed Research' : 'Add Completed Research' }}
                    </h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('frontend-menu.completed_research') }}" class="btn btn-info btn-sm"><i
                            class="fas fa-stream"></i> View Completed Research</a>
                </div>
                <div class="card-body">
                    <form
                        action="{{ !empty($editData) ? route('frontend-menu.completed_research.update', $editData->id) : route('frontend-menu.completed_research.store') }}"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                <label>Status</label>
                                <select required name="publish_status" id="publish_status" class="form-control select2">
