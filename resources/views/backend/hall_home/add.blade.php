...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Add Hall Home</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('manage_hall_home', $hall)}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Hall Home</a>
            </div>
            <div class="card-body">
                <form action="{{ route('manage_hall_home.store') }} " method="post" enctype="multipart/form-data" autocomplete="off">
