...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id=""  action="{{ route('top-menu.photo_gallery_master.store') }}"   method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            <label>Name</label>
                            <input id="name" type="text"  class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name"> @error('name')
                        ...
                        <div class="form-group col-sm-4">
                            <label>Type</label>
                            <select id="type_name" name="type" class="form-control select2" required>
