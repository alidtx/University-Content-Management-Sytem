                ...
                <form action="{{ !empty($editData)? route('site-setting.about.update',$editData->id) : route('site-setting.about.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-6">
                            <label>Large Image<small style="color: brown"> (resolution - 410*410,  Max 2 mb)</small></label>
                            <input type="file" class="form-control filer_input_single @error('large_image') is-invalid @enderror" name="large_image"> @error('large_image')
                        ...
                        <div class="form-group col-sm-6">
                            <label>Small Image<small style="color: brown"> (resolution - 210*210, Max 2 mb)</small></label>
                            <input type="file" class="form-control filer_input_single @error('small_image') is-invalid @enderror" name="small_image"> @error('small_image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
