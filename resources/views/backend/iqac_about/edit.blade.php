    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('manage_iqac_about')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Team Member</a>
            </div>
            <div class="card-body">
                <form action="{{ route('manage_iqac_about.update', $editData->id) }} " method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea type="text"  class="form-control @error('short_description') is-invalid @enderror textarea " name="short_description">{{ !empty($editData->description)? $editData->description : old('short_description') }} </textarea>
