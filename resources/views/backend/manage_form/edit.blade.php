    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('manage_form.update', $editData->id) }} " method="post"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ $editData->title }}" name="title" placeholder="Title"
                                    class="form-control">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" value="{{ $editData->publish_date }}" name="publish_date"
