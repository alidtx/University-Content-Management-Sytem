...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List of Form</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('manage_form.add') }}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i>
                                Add Form</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($form as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('manage_form.edit', $item->id) }}"
                                                    ...
                                                    data-route="{{ route('manage_form.delete') }}"
