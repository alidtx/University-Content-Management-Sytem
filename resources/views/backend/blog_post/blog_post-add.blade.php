                ...
                <form action="{{ !empty($editData)? route('blog-management.blog_post.update',$editData->id) : route('blog-management.blog_post.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input id="title" name="title" type="text" value="{{@$editData->title}}" class="form-control @error('title') is-invalid @enderror" placeholder="Post Title">
                            @error('title')
                        ...
                        <div class="form-group col-sm-12">
                            <label style="font-size: 20px;">Author Name</label>
                            <input id="author_name" name="author_name" type="text" value="{{ @$editData->author_name }}" class="form-control @error('author_name') is-invalid @enderror" placeholder="Author Name">
                            @error('author_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea  name="description" class="textarea @error('description') is-invalid @enderror" required="">{{@$editData->description}}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
