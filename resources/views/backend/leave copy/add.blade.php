...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('manage_leave.store') }} " method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input id="start_by" type="date" value=""
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input id="end_by" type="date" value=""
                    ...
                    <button class="btn bg-gradient-success btn-sm"><i class="fas fa-save"></i> Save Leave</button>
                </form>
