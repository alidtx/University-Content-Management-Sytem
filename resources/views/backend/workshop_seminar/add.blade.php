    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('manage_workshop_seminar')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> Add Work Shop Seminar</a>
            </div>
            <div class="card-body">
                <form action="{{ route('manage_workshop_seminar.store') }} " method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            <label>Seminar</label>
                            <input id="seminar" type="text" value="" class="form-control @error('seminar') is-invalid @enderror" name="seminar" placeholder="Write seminar name"> @error('seminar')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
                    ...
                    <button class="btn bg-gradient-success btn-flat"><i class="fas fa-save"></i>Training Seminar Office</button>
                </form>
