...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Library to Member' : 'Add Library to Member' }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Library to Member</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('library_to_member.list')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View library to Member</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('library_to_member.update',$editData->id) : route('library_to_member.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="form-row">
