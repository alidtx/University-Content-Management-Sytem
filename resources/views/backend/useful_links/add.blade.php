...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ !empty($editData)? 'Update Footer Block 1' : 'Add Footer Block 1' }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Footer Block 1</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('footer-menu.useful.links')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> View Footer Block 1</a>
            </div>
            <div class="card-body">
                <form action="{{ !empty($editData)? route('footer-menu.useful.links.update',$editData->id) : route('footer-menu.useful.links.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <button class="btn bg-gradient-success btn-sm"><i class="fas fa-save"></i> {{ !empty($editData)? 'Update Footer Block 1' : 'Save Footer Block 1' }}</button>
                </form>
