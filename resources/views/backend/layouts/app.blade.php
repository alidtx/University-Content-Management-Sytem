...
<head>
  ...
  <title>Comilla University | Admin</title>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('public/pixelarity/pixelarity.css') }}">
  {{-- Pixelarity (Crop) --}}
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #0072bc; color: #ffffff">
  ...
  {{--  --}}
  <script type="text/javascript" src="{{ asset('public/pixelarity/pixelarity-face.js') }}"></script>
  <script type="text/javascript" src="{{ asset('public/pixelarity/script-face.js') }}"></script>
      ...
      <div class="card-body" style="padding: 0;">
        <div id="accordion" role="tablist">
          <div class="card" style="margin-bottom: 0px !important;">
            ...
            <div class="card-header" role="tab" id="headingprogramList" style="padding: 0 0;">
                <h5 class="mb-0">
                  <a style="display: block;padding: .75rem 1.25rem;" class="collapsed plusminuscollapse" data-toggle="collapse" href="#collapseprogramList" aria-expanded="false" aria-controls="collapseprogramList">
                    Program List<i class="fa fa-plus plusminusbutton" style="float:right"></i>
                  </a>
                </h5>
              </div>
              <div id="collapseprogramList" class="collapse" role="tabpanel" aria-labelledby="headingprogramList" data-parent="#accordion">
                <table class="table table-hover" style="margin-bottom: 0;">
                  <tbody>
                    @php
                    $programs = App\Model\Program::where('status','1')->get();
                    @endphp
                    @foreach($programs as $program)
                    <tr>
                      <td class="linkdata" data-url_type="5" data-id="{{$program->slug}}" style="cursor: pointer;background: #584200;color:white;font-weight: bold;">{{$program->name}}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
