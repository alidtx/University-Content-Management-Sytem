                ...
                <form action="{{ !empty($editData)? route('member_to_employee.update',$editData->id) : route('member_to_employee.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input id="ext_no" type="number" value="{{ !empty($editData->ext_no)? $editData->ext_no : old('ext_no') }}" class="form-control @error('ext_no') is-invalid @enderror" name="ext_no" placeholder="Enter Extension Number">
                            @error('ext_no')
