 ...
 <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">News | Event | Notice | Press Release</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
        	<div class="col-lg-12">
                ...
                <a href="{{ route('site-setting.news.add') }}" class="btn btn-sm btn-info" style="text-align: left"><i class="fas fa-plus"></i> Add News | Event | Notice | Press Release</a>
                ...
                <a href="{{ route('site-setting.news.filter_press_release') }}" class="btn btn-sm btn-info float-right" style="margin-right: 2px;"><i class="fas fa-stream"></i> Press Release</a>
                ...
                <a href="{{ route('site-setting.news') }}" class="btn btn-sm btn-info float-right" style="margin-right: 2px;"><i class="fas fa-stream"></i> All</a>
                    ...
                    <td>{{ $loop->iteration }}</td>                                     
                      ...
                      <td><img src="{{asset('public/upload/news/'.$n['image']) }}" width="80" height="80" onerror="this.onerror=null;this.src='{{ asset('public/frontend/cuimages/dummy.png') }}';" ></td>
                      @if(!empty($n['file']))
